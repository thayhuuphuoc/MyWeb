		...
		<>
			<div className="mt-10 mb-6">
				<h1 className="container mx-auto px-5 text-center text-2xl md:text-3xl font-bold m-0">
					Tôi rất vui khi được lắng nghe ý kiến từ bạn!
				</h1>
			</div>
					...
					<div className="flex flex-col lg:flex-row items-start gap-8">
						<div className="relative bg-primary rounded-md w-full lg:max-w-sm">
							...
							<div className="flex flex-col gap-4">
								<h6 className="text-white font-bold text-lg">Liên hệ với tôi</h6>
								<p className="text-white/90">Bạn có câu hỏi hoặc cần hỗ trợ? Tôi luôn sẵn sàng phản hồi tin nhắn của bạn.</p>
							</div>
