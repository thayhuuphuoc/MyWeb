...
import BlogCategoriesList from "@/components/public/posts/blog-categories-list";
		...
		<div className="container mx-auto max-w-[1400px] px-5">
			<div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
				...
				<div className="hidden lg:block lg:order-2">
					<div className="w-full lg:w-[350px] flex-shrink-0 lg:sticky lg:top-4 lg:self-start">
						<LatestPostsSidebar posts={latestPosts} />
						{/* Categories List - Below Latest Posts, fixed position */}
						<BlogCategoriesList 
